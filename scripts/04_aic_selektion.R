...
# aufgenommen bzw. entfernt), nicht als einzelne Kontraste. Nur Fälle mit
# gültiger Arbeitszufriedenheit (siehe Hinweis in Schritt 1/3) gehen ein.
...
# Bei drei Prädiktorblöcken lassen sich alle 2^3 = 8 möglichen Modelle
